...
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'us_employment_dataset')
...
with DAG(
    ...
    bq_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                ...
                "sourceUris": [f"gs://{BUCKET}/processed/us_*"]
            }
        }
    )
    ...
    CREATE_BQ_TBL_QUERY = (
        ...
        AS \
        SELECT * FROM {BIGQUERY_DATASET}.us_employment_external_table_prod;"
    )
